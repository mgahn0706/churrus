      ...
      <Box display="block" color="white" mx={15} mt={15}>
        ...
        <TabPanel value={tabValue} index="solution">
          <Typography variant="body1" mb={2}
            ...
            필요합니다. <br />
            첫째, 한채원이 위스키를 물약통에 따로 마신다는 점을 알아야합니다. 둘째로,
            그 물약통을 한채원 혼자서만 마신다는 사실을 알아야합니다.
            한채원은 제품 팀 구성원들하고만 해당 물약통을 썼으므로, 비즈니스 팀인 박지혁은 이 사실을 알기 힘들 것입니다.
            강지혜는 Cask Strength 를 검색해보는 등 한채원을 조사한 흔적이 있으므로 해당 사실을 알 가능성이 있습니다.
            <br/>
            또, 위스키 물약통을 바꿔치기하기 위해서는 바꿔치기를 할 시간이 있어야합니다. 위스키 물약통은 5월 25일 저녁까지 정상이었으므로, 살해 당일인 5월 27일까지의 시간 중에 바꿔치기가
            이루어졌어야 합니다.
            한채원이 유일하게 자리를 비운 시간은 26일 7시 30분 이후입니다. 점심시간에는 한채원을 포함해 항상 사무실에서 점심을 먹는 사람들이
            있었기 떄문에 해당 시간에 바꿔치기는 힘들었을 것입니다.
            <br/>
            따라서 범행이 가능한 시간은 5월 26일 저녁입니다. 하지만, 이 날은 모두 한채원보다 일찍 퇴근했습니다. 즉, 범인은 퇴근 기록을 남기고
            뒷문으로 들어와 저녁 8시 이전에 범행을 마치고 나왔다는 의미가 됩니다. 회사에 아무도 없다고 판단이 섰을 때, 빠르게 뒷문으로 들어갔다 나온 것이지요.
            여기서 8시까지 모두 회사에서 나온다는 보장이 없기에, 마지막에 나오면서 사무실이 비었음을 확신할 수 있었던 김성균의 범행 가능성이 매우 높아집니다.
            범인은 이렇게 위스키 물약통을 한채원의 서랍에서 바꿔치기합니다. 그런데, 범인은 바꿔치기하는 물약통에 굳이 한채원의 네임펜을 써가며
            Cask Strength ABV 17이라는, 말이 안되는 메모를 남겼습니다.
            범인은 8시까지 나가야했으니 10분밖에 시간이 없었을 겁니다. 범인은 물약통에 메모가 남겨져있음을 몰랐고, 바꿔치기하는 그 상황에서 다급하게 원래 물약통의 글씨를 따라 썼을 것입니다.
            하지만, 한채원의 악필로 인해 '67'과 '17'을 구별하지 못하고 '생위스키 알코올 도수 17도'라는 말이 안되는 메모를 남기게 된 것입니다. Cask strength 를 미리 검색해본 강지혜나,
            휴림 출신인 박지혁은 이런 실수를 하기 힘들었을 것입니다. 유일하게 술에 대해 무지했던 김성균이 범인일 가능성이 매우 높아졌습니다.
            <br/>
            마지막으로, 동기입니다. 강지혜는 스파이 의심을 살해 전에 받긴 했지만, 해당 문자는 사건 당일 오후에 받아 이런 계획 범죄를 진행하기 어려웠을 것입니다. 박지혁은 충분한 살해동기가 있고, 실제로
            과도를 준비하여 살해를 계획한 것처럼 보입니다. 하지만, 살해 방법은 독살이기 때문에, 과도는 '혹시 죽지 않았을 경우 찔러 죽일 도구' 의 역할일 것입니다.
            그렇다기에는 굳이 '퇴근 후 따로 만나서 보자' 는 증거를 한채원에게 남겨 본인에게 불리하게 했으며 사람을 죽이기 힘든 '작은' 과도를 준비했다는 점이 이상합니다.
            아마 과도는 협박용으로 보는 것이 타당할 것입니다. 어쩌면 자해용으로 말이죠.
            <br/>
            한편 김성균은 한채원을 짝사랑하고 있었고, 한채원의 노트북의 비밀번호도 쉽게 알았을 것입니다. 25일 한채원과 김성균의 대화로 미루어보아, 김성균은 한채원의 말에 의심을 품
            기 충분하며, 노트북에서 발표문을 보았을 가능성이 높습니다. 실제로 해당 날짜에 퇴근시간이 늦게 찍혀있고요.
            집으로 돌아가는 길에 '농도가 높은 니코틴' 을 구매했으며 26일에 범행을 저질렀다고 하면 모든 흐름이 맞게 됩니다.
            마지막으로, 건배를 먼저 유도함으로써 빠르게 한채원이 니코틴을 마시게 한 사람도 김성균입니다.
            <br/>
        ...
        <ListItemText
                ...
                secondary={
                  <Typography variant="body1" sx={{wordSpacing: 3, lineHeight: 2.5, wordBreak : 'keep-all'}}>
                    저는 2019년에 만들어진 와플러브에서 온 스파이입니다. 

와플러브는 와플스튜디오의 회장 심현수가 저를 비롯한 동아리원들과 함께 만든 스타트업입니다. 추러스와 비슷하게 주변 와플가게 추천 기능과 더불어 인공지능 간식추천 서비스를 제공하고있어요. 와플러브가 시작이 늦었기에, 경쟁사인 추러스보다 기능도 적고 성능도 안좋았죠. 저는 와플러브에서 앱 개발을 하고있는데, 많은 기술적 한계에 부딪혔어요.

그래서 손현수는 2020년 3월 저에게 하나 제안을 했죠. 추러스에 마케팅 담당자로 위장취업을 한 뒤, 추러스 내부의 정보들을 최대한 빼내오는 이른바 스파이 역할을 맡아달라는거였어요.

개발자로 취업하지 않은 이유는, 추러스가 개발자를 채용하지 않는것 같아서였죠. 그래서 저는 인맥을 이용해 마케팅 인턴으로 취업을 했습니다. 한채원씨와는 안면이 있었거든요.

2020년에 무사히 위장취업을 했어요. 마케팅 실력은 정말정말 부족했지만, 제품팀 구역을 자주 오다니며 여러 정보들을 기록하고, 손현수에게 보냈죠.

실적, 전략은 물론이고 인공지능 코드나 불법행위 등까지 말입니다. 덕분에 인공지능 성능의 결함을 와플러브가 폭로할 수 있었어요. 월급은 동결되고 있었지만 저는 상관없었죠. 손현수에게 일정량의 금액을 계속 받고 있었거든요.

저는 좀더 많은 정보를 원했어요. 마케팅보다는 이런게 적성에 맞았거든요.

데이터 접근 권한도 얻고, 도청기를 설치해서 구성원끼리 몰래 대화하는것까지 녹음해두었어요.

한채원은 제게 일 못한다고 , 해고한다고 뭐라했지만,  저는 해고당하기전까지는 계속할 예정이었어요.

사건 당일 오후 5시, 한채원에게서 dm이 왔습니다. 내용은 제 행적이 수상하다며, 뒷조사를 하겠다는 내용이죠. 제가 지나치게 데이터와 문서들에 접근하고, 퇴근도 늦게해서 그런것일까요. 한채원은 어느정도 눈치를 챈 모양입니다.

너 수상하다면서, 숨기고 있는게 있는 것 같다는 얘기였죠

저는 이제 들켰구나하고 

이후, 파티에 참가했어요. 제 입사 3주년을 기념해서 열린 거였는데, 사실 불안했어요. 혹시 스파이인게 들키면 어떡하지하고요. 그래서 예전부터 준비한 사직서에 내일 날짜를 적고 빠르게 회사를 뜨려고 했죠.

저는 공용 오피스 컵에 얼음을 담기 시작했어요. 4개의 잔에 얼음을 담아 나눠줬습니다. 한채원은 위스키를 넣었고 한채원이 나머지 구성원에게 브랜디를 따라주었어요. 건배 후, 한채원이 쓰러졌습니다.

고통스럽게, 위스키를 마시고 바닥에 쓰러졌습니다. 제가 준 얼음이 잘못되었던 것일까요?

아니, 어쩌면 이건 좋은 기회일지도 모릅니다. 119를 빨리 부르지 않는다면 제 스파이 행적이 영원히 사라질 수도 있을 것 같거든요.
                  </Typography>
                }
              />
                 <ListItemText
                ...
                secondary={
                  <Typography variant="body1" sx={{wordSpacing: 3, lineHeight: 2.5, wordBreak : 'keep-all'}}>
                    다. 119를 빨리 부르지 않는다면 제 스파이 행적이 영원히 사라질 수도 있을 것 같거든요.
                  </Typography>
                }
              />
        </TabPanel>
