      ...
      <Box display="block" color="white" mx={15} mt={15}>
        ...
        <TabPanel value={tabValue} index="solution">
          ...
          >
            ...
            미루어보아, 김성균은 한채원의 말에 의심을 품 기 충분하며, 노트북에서
          ...
          <ListItemText
            ...
            secondary={
              <Typography
                ...
                sx={{ wordSpacing: 3, lineHeight: 2.5, wordBreak: "keep-all" }}
              >
                저는 2019년에 만들어진 와플러브에서 온 스파이입니다. 와플러브는
                와플스튜디오의 회장 심현수가 저를 비롯한 동아리원들과 함께 만든
                스타트업입니다. 추러스와 비슷하게 주변 와플가게 추천 기능과
                더불어 인공지능 간식추천 서비스를 제공하고있어요. 와플러브가
                시작이 늦었기에, 경쟁사인 추러스보다 기능도 적고 성능도
                안좋았죠. 저는 와플러브에서 앱 개발을 하고있는데, 많은 기술적
                한계에 부딪혔어요. 그래서 손현수는 2020년 3월 저에게 하나 제안을
                했죠. 추러스에 마케팅 담당자로 위장취업을 한 뒤, 추러스 내부의
                정보들을 최대한 빼내오는 이른바 스파이 역할을
                맡아달라는거였어요. 개발자로 취업하지 않은 이유는, 추러스가
                개발자를 채용하지 않는것 같아서였죠. 그래서 저는 인맥을 이용해
                마케팅 인턴으로 취업을 했습니다. 한채원씨와는 안면이 있었거든요.
                2020년에 무사히 위장취업을 했어요. 마케팅 실력은 정말정말
                부족했지만, 제품팀 구역을 자주 오다니며 여러 정보들을 기록하고,
                손현수에게 보냈죠. 실적, 전략은 물론이고 인공지능 코드나
                불법행위 등까지 말입니다. 덕분에 인공지능 성능의 결함을
                와플러브가 폭로할 수 있었어요. 월급은 동결되고 있었지만 저는
                상관없었죠. 손현수에게 일정량의 금액을 계속 받고 있었거든요.
                저는 좀더 많은 정보를 원했어요. 마케팅보다는 이런게 적성에
                맞았거든요. 데이터 접근 권한도 얻고, 도청기를 설치해서
                구성원끼리 몰래 대화하는것까지 녹음해두었어요. 한채원은 제게 일
                못한다고 , 해고한다고 뭐라했지만, 저는 해고당하기전까지는 계속할
                예정이었어요. 사건 당일 오후 5시, 한채원에게서 dm이 왔습니다.
                내용은 제 행적이 수상하다며, 뒷조사를 하겠다는 내용이죠. 제가
                지나치게 데이터와 문서들에 접근하고, 퇴근도 늦게해서
                그런것일까요. 한채원은 어느정도 눈치를 챈 모양입니다. 너
                수상하다면서, 숨기고 있는게 있는 것 같다는 얘기였죠 저는 이제
                들켰구나하고 이후, 파티에 참가했어요. 제 입사 3주년을 기념해서
                열린 거였는데, 사실 불안했어요. 혹시 스파이인게 들키면
                어떡하지하고요. 그래서 예전부터 준비한 사직서에 내일 날짜를 적고
                빠르게 회사를 뜨려고 했죠. 저는 공용 오피스 컵에 얼음을 담기
                시작했어요. 4개의 잔에 얼음을 담아 나눠줬습니다. 한채원은
                위스키를 넣었고 한채원이 나머지 구성원에게 브랜디를
                따라주었어요. 건배 후, 한채원이 쓰러졌습니다. 고통스럽게,
                위스키를 마시고 바닥에 쓰러졌습니다. 제가 준 얼음이 잘못되었던
                것일까요? 아니, 어쩌면 이건 좋은 기회일지도 모릅니다. 119를 빨리
                부르지 않는다면 제 스파이 행적이 영원히 사라질 수도 있을 것
                같거든요.
              </Typography>
            }
          />
          <ListItemText
            ...
            secondary={
              <Typography
                ...
                sx={{ wordSpacing: 3, lineHeight: 2.5, wordBreak: "keep-all" }}
              >
                다. 119를 빨리 부르지 않는다면 제 스파이 행적이 영원히 사라질
                수도 있을 것 같거든요.
              </Typography>
            }
          />
