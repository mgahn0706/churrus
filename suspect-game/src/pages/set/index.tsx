...
export default function Set() {
  ...
  return (
    <>
      <GlobalHeader />
      <Box textAlign="center" pt={10} width="100%" justifyContent="center">
        <RuleVideoButton url="QUVbVeWz5cs" />
        <Box position="fixed" top="70px" right="40px" m={1}>
          <Tooltip
          ...
          <Button
            ...
            onClick={() => {
              ...
              setScore({
                ...score,
                player1:
                  currentPlayer === 1 ? score.player1 + 3 : score.player1,
                player2:
                  currentPlayer === 2 ? score.player2 + 3 : score.player2,
              });
              setSelectedPictures([]);
              setAcceptedSets([]);
              setRound(round + 1);
