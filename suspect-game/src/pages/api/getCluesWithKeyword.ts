...
export const schoolClues: ClueData[] = [
  ...
  {
    id: 38,
    text: "민헤 오늘 자습실에 좀 늦게 들어왔어요. 한 8시? 에 들어왔던 것 같은데. 그러고는 8시 18분쯤에 물 마시러간다고 나갔는데, 갑자기 비명소리가 들리더니...",
    from: "3-3 신수현",
  },
  {
    id: 39,
  ...
  {
    id: 67,
    text: "저흐 학교에서는 동이라 기장들이, 동아리 활동을 전날에 준비해요. 내일도 동아리 활동이 있을 예정이었죠. 아마 기장들은 각자 동아리실에서 준비하고 있었을 거에요.",
    from: "3-1 이수민",
  },
  {
    id: 68,
  ...
  {
    id: 90,
    text: "9월 2일자 위클리와부 십자말풀이 모양이 좀 이상해요. 8월 23일자와 달라요. 어떻게 십자말풀이가 3*3 정사각형 모영으로 나오죠?",
    from: "조수",
  },
  {
    id: 91,
