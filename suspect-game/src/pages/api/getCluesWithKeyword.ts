...
export const schoolClues: ClueData[] = [
  ...
  {
    id: 67,
    text: "저희 학교에서는 동이라 기장들이, 동아리 활동을 전날에 준비해요. 내일도 동아리 활동이 있을 예정이었죠. 아마 기장들은 각자 동아리실에서 준비하고 있었을 거에요.",
    from: "3-1 이수민",
  },
  {
    id: 68,
  ...
  {
    id: 91,
    text: "크로스워드, 다시 말해 십자말풀이는 자고로 영어로 내야하는데, 한국어로는 그게 안돼서 아쉽습니다. 원래 정사각형 안에서 모든게 이뤄져야하는데! 한글로는 도저히 그렇게 만들 수가 없어요. 아니, 없었어요.",
    from: "3-2 현태민",
  },
];
