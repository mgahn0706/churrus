...
export const startUpClues: ClueType[] = [
  ...
  },
  {
    ...
    reliability: "medium",
    description:
      "점심에 저희 회사는 보통 나가서 먹거나 배달시켜 먹는 사람이 대부분이에요. 오늘 점심이요? 저는 사무실에서 시켜먹었습니다. 항상 사무실에서 시켜먹는 사람들이 있거든요. 채원님은 평소에는 자리에서 시켜드시다가, 오늘은 지혁님이랑 같이 점심 드시러 간 것 같고... 다른 사람은 잘 모르겠네요. 수상한 행적은 딱히 없었는데요. ",
    type: "basic",
    image: "/Suspect_Logo.png",
    place: "lounge",
  },
  ...
  },
  {
    ...
    reliability: "medium",
    description:
      "채원님은 술 좋아하셨죠. 소주 맥주도 좋아하시긴 하는데, 술자리보다는 술을 좋아해서 위스키나 브랜디 이런거 혼술하는거 좋아하십니다. 따로 물약통 같은데 담아서 매번 먹는다니까요. 제품팀 회식 했다면 한번 쯤 먹는거 다 봤을텐데? 아, 비즈니스팀이면 모를 수도 있겠네요. 저랑 며칠전, 그러니까 5월 24일 저녁에도 한번 드셨어요. 그때는 괜찮았는데...",
    type: "basic",
    image: "/Suspect_Logo.png",
    place: "lounge",
  },
  ...
  },
  {
    ...
    reliability: "high",
    description:
      '추러스의 경쟁사 와플러브는, 2020년, 서울대학교 개발동아리 와플스튜디오에서 시작한 스타트업입니다. 대표 심현수는 "내 주변 가까운 와플 가게 찾기 어플"을 선보였으며, 그 후 다양한 종류의 간식으로까지 사업 범위를 확장했습니다. 국내 1위 간식 어플 기업 추러스의 뒤를 최근 빠르게 쫓고 있는 추세입니다.',
    type: "basic",
    image: "/Suspect_Logo.png",
    place: "office",
  },
  ...
  },
  {
    ...
    reliability: "high",
    description:
      "아직 인쇄되지 않은 발표문이다. 내용은 지난 와플러브에서 폭로한 개인정보 유출 사건이 사실이며, 이는 데이터 관리자의 독단적인 결정이었음을 폭로하는 내용이다. 이에 따라 데이터 관리자 김성균 외 1명을 해고하고 개인정보보호법에 따라 적법하게 처벌하겠다는 내용의 발표문이다. 적혀있는 발표 일자는 6월 1일이다.",
    type: "additional",
    image: "/Suspect_Logo.png",
    place: 24,
  },
  ...
  },
  {
    ...
    reliability: "high",
    description:
      "한채원의 서랍에서 발견된 메모이다. 악필 때문에 잘 읽히지는 않지만, 볼펜으로 쓰여졌고, 정부 지원금이 최근 와플러브의 개인정보 유출 폭로로 인해 취소될 위기에 있다는 내용이다. 이 외에도 8개 이상의 투자사에서 투자가 끊길 위기에 있다는 내용으로 보인다.",
    type: "additional",
    image: "/Suspect_Logo.png",
    place: 25,
  },
  ...
  },
  {
    ...
    reliability: "high",
    description:
      "평소 박지혁이 자주 즐겨보는 위스키 도서이다. 책에는 위스키에 대한 내용들이 적혀있다.",
    type: "basic",
    image: "/Suspect_Logo.png",
    place: "office",
  },
  ...
  },
  {
    ...
    reliability: "high",
    description:
      "김성균의 지갑이다. 내용물은 신분증, 현금 10만원 등이 들어있다. 특이한 점으로는 2015년에 화학생물공학부 조별 활동에서 찍은 사진이 들어있다. 사진에는 김성균과 한채원이 찍혀있다.",
    type: "basic",
    image: "/Suspect_Logo.png",
    place: "office",
  },
  {
    ...
    reliability: "high",
    description:
      "10분 이상 PC,노트북에서 활동이 없으면 자동으로 자리 비움 메시지가 전송된다. 해당 채널은 메시지들이 올라오는 곳으로 보인다.",
    type: "basic",
    image: "/Suspect_Logo.png",
    place: "office",
  },
