...
export const startUpClues: ClueType[] = [
  ...
  },
  {
    ...
    x: 17.148, y: 39.623,
    reliability: "high",
    description: "빨간색 립스틱이다. 사용 흔적이 있다. 그 외에 별다른 것은 없어보인다.",
    type: "additional",
    image: "/Suspect_Logo.png",
    place: 7,
  }
  ,
  {
    ...
    x: 7.148, y: 29.623,
    reliability: "high",
    description: '강지혜의 스마트폰이다. 기종은 갤럭시 폴드2이다. 잠금해제는 강지혜의 도움을 받아 열었다.',
    type: "additional",
    image: "/Suspect_Logo.png",
    place: 7,
  }
  ,
  {
    ...
    x: 7.148, y: 29.623,
    reliability: "high",
    description: '강지혜의 스마트폰에 저장된 음성파일이다. 김성균과 한채원의 목소리가 들린다. 잘은 들리지 않지만, 김성균이 한채원에게 호감의 표시를 하는 듯한 뉘앙스가 느껴진다. 한채원은 이에 "이번에도 잘 부탁한다."며 "덕분에 잘 해결될 것 같다"라는 말들이 오고간다. 녹음된 시간은 그리 길지 않다.',
    type: "additional",
    image: "/Suspect_Logo.png",
    place: 20,
  },
...

  {
    ...
    place: "office",
    password: "0801",
    passwordHint: "한채원의 PC는 잠겨있다. 비밀번호 힌트로 '내 생일' 이라고 적혀있다.", 
  }
  ,
  {
    id: 25,
  ...
  },
  {
    ...
    x: 5.176, y: 64.862,
    reliability: "high",
    description: '추러스의 경쟁사 와플러브는, 2020년, 서울대학교 개발동아리 와플스튜디오에서 시작한 스타트업입니다. 대표 심현수는 "내 주변 가까운 와플 가게 찾기 어플"을 선보였으며, 그 후 다양한 종류의 간식으로까지 사업 범위를 확장했습니다. 국내 1위 간식 어플 기업 추러스의 뒤를 최근 빠르게 쫓고 있는 추세입니다.',
    type: "basic",
    image: "/Suspect_Logo.png",
    place: "office",
  },
  {
    ...
    x: 42.775, y: 6.213,
    reliability: "high",
    description: '마케팅 팀에서 일하고 있는 강지혜의 맥북이다. 잠금해제는 강지혜의 도움으로 풀 수 있었다. 사내에서 지원해준 PC가 아닌, 개인 맥북을 사용하고 있다.',
    type: "basic",
    image: "/Suspect_Logo.png",
    place: "office",
  },
  {
    ...
    x: 10.775, y: 31.213,
    reliability: "high",
    description: '강지혜의 네이버 검색기록이다. Cask Strength, ABV 등의 검색어가 보인다.',
    type: "additional",
    image: "/Suspect_Logo.png",
    place: 29,
  },
  ...
  },
  {
    ...
    x: 17.650, y: 43.984,
    reliability: "high",
    description: '박지혁의 PC이다. 안에 여러가지 기록들이 보인다.',
    type: "basic",
    image: "/Suspect_Logo.png",
    place: "office",
  },
  {
    ...
    x: 80.208, y: 38.757,
    reliability: "high",
    description: '김성균의 PC이다. 안에 여러가지 기록들이 보인다. 데이터 관리자 직책이어서 그런지 보안이 굉장히 강화되어있다.',
    type: "basic",
    image: "/Suspect_Logo.png",
    place: "office",
  },
  {
    ...
    x: 20.208, y: 23.757,
    reliability: "high",
    description: '아직 인쇄되지 않은 발표문이다. 내용은 지난 와플러브에서 폭로한 개인정보 유출 사건이 사실이며, 이는 데이터 관리자의 독단적인 결정이었음을 폭로하는 내용이다. 이에 따라 데이터 관리자 김성균 외 1명을 해고하고 개인정보보호법에 따라 적법하게 처벌하겠다는 내용의 발표문이다. 적혀있는 발표 일자는 6월 1일이다.',
    type: "additional",
    image: "/Suspect_Logo.png",
    place: 24,
  },
  {
    ...
    x: 20.208, y: 28.757,
    reliability: "high",
    description: '2023년 3월 1일, 와플러브에서 추러스의 인공지능 스낵 지니어스가 기초부터 잘못 설계된 엉터리 인공지능임을 폭로했다. 이에 따라 추러스의 이미지는 급락했다.'
    ,type: 'additional',
    image: "/Suspect_Logo.png",
    place: 24,}
    ,{
    ...
    x: 20.208, y: 38.757,
    reliability: "high",
    description: '한채원의 서랍에서 발견된 네임펜이다. 포장을 금방 뜯은 듯 새것 같지만, 펜촉이 미세하게 닳아있어 아주 약간의 사용감이 느껴진다.'
    ,type: 'additional',
    image: "/Suspect_Logo.png",
    place: 25,}
    ,{
    ...
    x: 20.208, y: 43.757,
    reliability: "high",
    description: '한채원의 서랍에서 발견된 메모이다. 악필 때문에 잘 읽히지는 않지만, 볼펜으로 쓰여졌고, 정부 지원금이 최근 와플러브의 개인정보 유출 폭로로 인해 취소될 위기에 있다는 내용이다. 이 외에도 8개 이상의 투자사에서 투자가 끊길 위기에 있다는 내용으로 보인다.',
    type: "additional",
    image: "/Suspect_Logo.png",
    place: 25}
    ,{
