...
export const schoolInterview: Record<
  string,
  [
...
> = {
  손민혜: [
    [
      ...
      {
        question: '오늘 "박현성"이랑 어떤 대화를 나눴어?',
        answer:
          "박현성..? 아무 대화도 안나눴어요. 만난 적도 없고요. 아... 점심 때 만났었나. 그때는 뭐라고 했었지..? 몰라요. 그런걸 어떻게 다 기억해요?",
      },
    ],
    [
      {
        question: "화학 동아리 준비때는 뭘 했어?",
        answer:
          "별거 있나요. 내일은 활동 포스터 꾸미기 날이 있어요. 그래서 포스터를 꾸미는데 필요한 준비물을 화학실에서 찾아보고 있었어요. 전지나, 풀, 가위 등등...",
      },
      {
        question: "너가 박현성을 죽인거 아니야?",
        answer:
          "무슨소리세요. 계가 나한테 뭘한게 있다고. 형사? 탐정? 이라고 말 막해도 되는건가요?",
      },
    ],
    [
      {
        question: "휴대폰에서 최근에 무슨 내용으로 문자를 보냈어?",
        answer:
          "문자? 아 제 휴대폰에서 뭘 보셨군요? 아무것도 아니에요. 아마 급식이나 도시락관련 얘기일텐데, 그런 봉사를 하고 있어서 말이죠.",
      },
      {
        question: "친구가 죽어서 많이 힘들겠다. 안색이 많이 안좋아 보이네?",
        answer:
          "네 감사합니다. 손도 떨리고 요즘 잠도 잘 못 자요. 많이 힘들어보이죠? 사람 죽는건 처음 봐서...많이 힘드네요.",
      },
    ],
  ],
};
