...
export const startUpClues: ClueType[] = [
  ...
  },
  {
    ...
    reliability: "medium",
    description:
      "채원님은 술 좋아하셨죠. 소주 맥주도 좋아하시긴 하는데, 술자리보다는 술을 좋아해서 위스키나 브랜디 이런거 혼술하는거 좋아하십니다. 따로 물약통 같은데 담아서 서랍에 넣고 매번 먹는다니까요. 제품팀 회식 했다면 한번 쯤 먹는거 다 봤을텐데? 아, 비즈니스팀이면 모를 수도 있겠네요. 저랑 며칠전, 그러니까 5월 25일 저녁에도 한번 드셨어요. 그때는 괜찮았는데...",
    type: "basic",
    image: "/Suspect_Logo.png",
    place: "lounge",
  },
