...
export const CONNECTIONS2026: ConnectionsType[] = [
  {
    week: 1,
    quiz: [
      {
        words: ["트럼프", "루스벨트", "링컨", "워싱턴"],
        description: "미국의 대통령의 성",
      },
      {
        words: ["시안", "스칼렛", "크림슨", "베이지"],
        description: "색깔",
      },
      {
        words: ["시카고", "레미제라블", "마틸다", "렌트"],
        description: "뮤지컬 제목",
      },
      {
        words: ["다크나이트", "할리퀸", "버거킹", "스마트폰"],
        description: "체스 기물로 끝나는 단어",
      },
    ],
  },
  {
    ...
    quiz: [
      ...
      {
        words: ["13", "127", "347", "683"],
        description: "소수",
      },
      {
        words: ["505", "606", "815", "1003"],
        description: "한국의 공휴일",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        words: ["키보드", "마우스", "모니터", "스피커"],
        description: "컴퓨터의 주변기기",
      },
      {
        words: ["소다", "코코아", "스무디", "라떼"],
        description: "음료의 종류",
  ...
  },
  {
    ...
    quiz: [
      {
        words: ["온실", "정원", "화단", "밭"],
        description: "식물을 기르는 장소",
      },
      {
        words: ["독", "통", "단지", "용기"],
        description: "물건을 저장하는 도구",
      },
      {
        words: ["실리", "월드", "꼬깔", "아이"],
        description: "__ 콘",
  ...
  },
  {
    ...
    quiz: [
      {
        words: ["사이비", "씨앗", "에스트로겐", "쥐덫"],
        description: "알파벳이 포함된 단어",
      },
      {
        words: ["스트레스", "처방", "선물", "신내림"],
        description: "받을 수 있는 것",
      },
      {
        words: ["불가사의", "음계", "죄종", "일주일"],
        description: "일곱으로 구성되는 것",
      },
      {
        words: ["집합", "내일은 실험왕", "주기율표", "삼국지"],
        description: "원소가 있는 것",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    quiz: [
      ...
      {
        words: ["오스카", "로미오", "빅터", "마이크"],
        description: "사람 이름으로도 쓰이는 NATO 음성기호",
      },
    ],
  },
  {
    ...
    quiz: [
      ...
      {
        words: ["판다", "얼룩말", "스컹크", "범고래"],
        description: "흑백 무늬가 특징인 동물",
      },
      {
        words: ["캥거루", "코알라", "웜뱃", "오리너구리"],
        description: "호주를 대표하는 동물",
      },
      {
        words: ["말벌", "소라게", "사슴벌레", "코끼리조개"],
        description: "두 동물의 이름이 합쳐진 동물",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        words: ["송편", "떡국", "약과", "전"],
        description: "한국의 명절 음식",
      },
      {
        words: ["만두", "타코", "부리토", "김밥"],
        description: "속재료를 감싼 음식",
      },
      {
        words: ["마들렌", "진저", "올리브", "로즈마리"],
        description: "사람 이름으로도 쓰이는 음식 이름",
      },
      {
        words: ["샌드위치", "나초", "시저샐러드", "마르게리타"],
        description: "특정 인물의 이름에서 유래한 음식",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        description: "그리스 신화의 신",
      },
      {
        words: ["로스", "레이첼", "모니카", "피비"],
        description: "프렌즈의 등장인물",
      },
      {
        words: ["햄릿", "마틸다", "모아나", "록키"],
        description: "제목과 주인공 이름이 같은 작품",
      },
      {
        words: ["오스틴", "잭슨", "샬럿", "매디슨"],
        description: "미국 도시이면서 사람 이름",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        words: ["뉴턴", "와트", "파스칼", "볼트"],
        description: "사람 이름에서 유래한 물리 단위",
      },
      {
        words: ["코브라", "아나콘다", "맘바", "보아"],
        description: "뱀의 종류",
      },
      {
        words: ["사파이어", "에메랄드", "오팔", "토파즈"],
        description: "보석",
      },
      {
        words: ["자바", "파이썬", "스위프트", "루비"],
