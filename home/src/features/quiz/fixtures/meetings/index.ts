...
export const MEETINGS: Record<string, MeetingType> = {
  "OT-1": {
    id: "OT-1",
    title: "미술관",
    subtitle: "2026년 2학기 OT",
    imageSource: "/image/quiz/meeting/OT-1.png",
    quizIds: ["OT-1-1", "OT-1-2", "OT-1-3", "OT-1-4"],
    date: {
      year: 2026,
      month: 9,
    },
  ...
  "2026-MOVE-1": {
    id: "2026-MOVE-1",
    title: "시간여행",
    subtitle: "2026년 여름 대이동",
    imageSource: "/image/quiz/meeting/2026-MOVE-1.png",
    quizIds: [
      "2026-MOVE-1-1",
      "2026-MOVE-1-2",
      "2026-MOVE-1-3",
  ...
  "2026-7": {
    id: "2026-7",
    title: "2026 문제 공모전",
    subtitle: "2026년 7월 정기모임",
    imageSource: "/image/quiz/meeting/2026-7.png",
    quizIds: [
      "2026-7-1",
      "2026-7-2",
      "2026-7-3",
  ...
  "2026-6": {
    ...
    subtitle: "2026년 6월 정기모임",
    imageSource: "/image/quiz/meeting/2026-6.png",
    quizIds: [
      "2026-6-1",
      "2026-6-2",
      "2026-6-3",
  ...
  "2026-4": {
    ...
    subtitle: "2026년 4월 소이동",
    imageSource: "/image/quiz/meeting/2026-4.png",
    quizIds: [
      "2026-4-1",
      "2026-4-2",
      "2026-4-3",
  ...
  "2026-3": {
    ...
    title: "삼각형",
    subtitle: "2026년 3월 정기모임",
    imageSource: "/image/quiz/meeting/2026-3.png",
    quizIds: [
      "2026-3-1",
      "2026-3-2",
      "2026-3-3",
  ...
  "2026-OT-1": {
    ...
    title: "디저트",
    subtitle: "2026년 1학기 OT",
    imageSource: "/image/quiz/meeting/2026-OT-1.png",
    quizIds: [
      "2026-OT-1-1",
      "2026-OT-1-2",
      "2026-OT-1-3",
  ...
  "2026-2": {
    ...
    title: "추러스에 관하여",
    subtitle: "2026년 2월 정기모임",
    imageSource: "/image/quiz/meeting/2026-2.png",
    quizIds: [
      "2026-2-1",
      "2026-2-2",
      "2026-2-3",
  ...
  "2026-1": {
    ...
    title: "기하학 방탈출",
    subtitle: "2026년 1월 정기모임",
    imageSource: "/image/quiz/meeting/2026-1.png",
    quizIds: [
      "2026-1-1",
      "2026-1-2",
      "2026-1-3",
  ...
  "2025-12": {
    ...
    title: "Wicked",
    subtitle: "2025년 12월 정기모임",
    imageSource: "/image/quiz/meeting/2025-12.png",
    quizIds: [
      "2025-12-1",
      "2025-12-2",
      "2025-12-3",
