...
export const MIDDLE_RACE_CHARACTERS: MiddleRaceCharacterType[] = [
  ...
  },
  {
    ...
    priority: 9,
    ability:
      "자신이 다른 캐릭터의 특수능력을 받아 이동될 경우, 다른 플레이어 1명을 지목해 같은 수만큼 반대방향으로 이동시킨다.",
    color: "#590356",
  ...
  },
  {
    ...
    priority: 11,
    ability:
      "자신의 이동카드로 움직일 때 다른 플레이어가 있는 칸은 건너뛴다. 또한 0~4까지 5장의 이동카드를 사용하며 이동카드가 2장일때도 리셋할 수 있다. 단, 이동카드가 1장일 땐 리셋할 수 없다.",
    color: "#206163",
