...
export const dureSuspects: SuspectType[] = [
  {
    ...
    job: "추러스 부원",
    description:
      "물리천문학부 17학번 백장훈입니다. 예진이랑은 그냥 같은 동아리원 정도의 사이예요. 오늘 열심히 준비한 연극이 있어서 긴장하면서 왔는데, 이런 일이 생겼네요.",
    statement:
...

  {
    ...
    job: "추러스 임원진",
    description:
      "저는 고제준입니다. 예진이랑은 같이 임원진 활동하면서 많이 친했어요. 이런 일이 생기다니 안타깝네요. 그렇게 나쁜 친구는 아니었는데 말이죠.",
    statement:
...

  {
    ...
    job: "추러스 총무",
    description:
      "박선재라고 합니다. 이예진은 제가 사랑했던 사람입니다. 평생 함께하자고 했던 친구라고요!! 예진이가 없으면 전 어떻게 살죠? 죄송하지만 더이상 말하기 힘드네요..죄송합니다.",
    statement:
  ...
  },
  {
    ...
    statement:
      "오늘은 담배 피느라 주로 밖에 있었어요. 제 오랜 습관이어서요. 연극 시작 20분 전 쯤이었나. 돌아오는 김에 여러분들을 데려 온거고요. 그러고 사람들이랑 같이 306호에 갔더니 이 상황인겁니다. 불쌍한 예진…",
    finalArgument:
      "제가 범인이라구요? 저는 정말 정말 아닙니다. 잘못 짚으셨어요. 채원이는 저랑 공동 창업자일 뿐입니다. 비록 최근에 마음에 들지 않는 일들을 한건 맞지만, 죽일 생각은 안했어요. 게다가 니코틴으로 독살할 생각은 더더욱 하지 않았습니다. 애초에 전 한채원이 오늘 위스키를 마시는 줄도 몰랐어요!",
  },
];
...
export const dureVictim: VictimType = {
  ...
  statement: "",
  description:
    "추러스의 회장으로, 동아리 내에서 리더십을 발휘하는 인물이다. 추리에 진심인 인물로 이번 추리극을 처음 제안했다.",
};
