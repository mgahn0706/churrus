...
export const dureSuspects: SuspectType[] = [
  {
    ...
    job: "추러스 부원",
    description:
      "물리천문학부 16학번 백장훈입니다. 예진이랑은 그냥 같은 동아리원 정도의 사이에요. 오늘 열심히 준비한 연극이 있어서 긴장하면서 왔는데, 이런 일이 생겼네요.",
    statement:
...

  {
    ...
    statement:
      "오늘 저는 연극준비하느라 바빴어요. 예진이는 만나지 못했고요. 전 연극 30분 전에 도착해서 추리극 준비를 했습니다. 한 20분 전부터 예진이를 찾았는데, 아무데도 없더라고요. 10분정도 찾다가 다시 돌아왔습니다. 그리고 306호에 친구들과 같이 들어가보니 이 상태네요...참. 분명 306호는 잠겨있었는데 말이죠.",
    finalArgument:
