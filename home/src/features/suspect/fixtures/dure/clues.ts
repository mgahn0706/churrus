...
export const dureClues: ClueType[] = [
  ...
  },
  {
    ...
    y: 19.029,
    description:
      "채원님은 술 좋아하셨죠. 소주 맥주도 좋아하시긴 하는데, 술자리보다는 술을 좋아해서 위스키나 브랜디 이런거 혼술하는거 좋아하십니다. 따로 물약통 같은데 담아서 매번 먹는다니까요. 제품팀 회식 했다면 한번 쯤 먹는거 다 봤을텐데? 아, 비즈니스팀이면 모를 수도 있겠네요. 저랑 며칠전, 그러니까 5월 25일 저녁에도 한번 드셨어요. 그때는 괜찮았는데...",
    type: "basic",
    image: "/Suspect_Logo.png",
    place: "lounge",
  },
  ...
  },
  {
    ...
    description:
      '인사 담당자의 노트이다. 여러가지 사람들의 생일, 입사일 등의 정보가 적혀있다. 각 구성원의 비고한은 비어있지만, 강지혜의 비고란에만 "저성과자"라는 메모가 남겨져있다.',
    type: "basic",
    image: "/Suspect_Logo.png",
    place: "office",
  },
  ...
  },
  {
    ...
    description:
      "사용자들의 데이터에 접근할 수 있는 권한을 관리하는 프로그램이다. 데이터에 접근 가능한 사람은 김성균, 한채원, 강지혜이다. 대량의 개인정보가 인공지능에 이용된 시점은 2023년 4월 말이며, 한채원이 요청하였고 김성균이 승인한 것으로 확인된다.",
    type: "additional",
    image: "/Suspect_Logo.png",
    place: 33,
  },
