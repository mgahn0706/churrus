      ...
      <Box display="block" color="white" mx={15} mt={15}>
        ...
        <TabPanel value={tabValue} index="solution">
          ...
          >
            ...
            공백이 생깁니다. 또한 다른 인물들은 표지판을 바꿀 타당한 이유가
            없기에, 표지판을 바꾼 인물은 차림솔이라고 보는 것이 타당합니다.
            그러나 차림솔은 표지판이 있는 갈림길까지 왕복해야 하고, 추러스
            가게와 그 지점 사이는 편도 30분이 걸리며 뛸 수조차 없습니다. 즉
            왕복만 해도 최소 60분이 필요하므로, 차림솔에게 남는 시간은 5분
            정도뿐입니다. 그 짧은 시간 안에 표지판을 조작한 뒤 다시 절벽으로
            이동해 추리수와 몸싸움을 벌였다고 보기는 어렵습니다. 결국 차림솔은
            표지판을 바꾼 인물일 수는 있어도, 직접 추리수를 밀친 진범은
            아닙니다. <br />
