      ...
      <Box display="block" color="white" mx={15} mt={15}>
        ...
        <TabPanel value={tabValue} index="solution">
          ...
          >
            ...
            잠근 뒤 307호로 나왔다. <br />
            망치는 창문 밖 공간에서 발견되었습니다. 306호 안에는 각목, 몽둥이 등
            더 쉽게 보이는 도구들이 있었음에도, 범인은 굳이 망치를 사용했습니다.
            이는 망치의 위치를 살해 이전부터 알고 있었다는 뜻입니다. 범인이 창문
            밖에 숨어 있었고, 마침 옆에 있던 망치를 집어 든 상황이라면 모든 것이
