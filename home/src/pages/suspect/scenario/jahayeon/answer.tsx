      ...
      <Box display="block" color="white" mx={15} mt={15}>
        ...
        <TabPanel value={tabValue} index="solution">
          ...
          >
            ...
            것인데 이 사실은 사건 당일 오전에 나와 알리바이 트릭과 모임 약속을
            계획하기는 어려운 시간입니다. 심지어 실제 표절을 지시한 사람은
            김하연이 아니므로, 이구관이 김하연을 죽여야겠다는 확신을 가질
            근거또한 없습니다. 알리바이적인 측면에서도, 출입기록에 따르면 그는
            자정 이후 1동으로 다시 들어가지도 않았고, CCTV 기록으로 보아 다른
            장소로 옮겨 술을 더 먹지도 않았습니다. 몸싸움의 흔적도 없기에 그가
