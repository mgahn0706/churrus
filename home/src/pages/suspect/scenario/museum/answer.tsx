      ...
      <Box display="block" color="white" mx={15} mt={15}>
        ...
        <TabPanel value={tabValue} index="confess">
          ...
          >
            ...
            신약 비용이 6천만 원이었고, 제 월급 250만 원으로는 도저히 감당할 수
            ...
            CCTV는 아직 꺼져 있었어요. 저는 장갑을 낀 채 도투어의 몸을 전시실로
            끌고 갔어요. <br />
            그리고 기념품샵으로 뛰었어요. 시간이 없었어요. 저는 수레를 꺼내 도둑
            코스프레 복장, 보석 모형, 금화 모형, 추르 키링까지 잔뜩 담았어요.
            그의 시신에 도둑 복장을 입혀 ‘기념품을 훔치다 잡혀 싸움 끝에 죽은
            사람’처럼 보이게 만들려 한 거죠. 완벽하진 않아도 CCTV가 없으니 어느
            정도 혼란은 줄 수 있을 거라 생각했어요. 저는 사용한 몽둥이와 수레를
            시체 옆에 내려놨어요. <br />
            7시가 되자 저는 정문 밖 구석진 곳으로 가서 증거 문서를 라이터로
            태웠어요. 완전히 타지 않았지만, 원본은 없어진 셈이었죠. 그 뒤에 다시
            B동으로 돌아와 아무 일 없다는 듯 보수 작업을 했어요. 누군가 시체를
            발견하길 기다린 거죠. <br />
            7시 30분, 여성의 비명소리가 들렸어요. 개관 전이라 이상했지만, 그
            비명으로 상황이 끝났음을 저는 알았어요. 그 순간에도 저는 목장갑을
            그대로 끼고 있었어요. 제 손이 한 짓이니, 벗을 수도 없었죠. 이제 와
            말하자면… 저는 그날 딸을 살리려 했어요. 그리고 그 대가로 모든 걸
            잃었어요. <br />
          </Typography>
        </TabPanel>
        ...
        <TabPanel value={tabValue} index="solution">
          ...
          >
            ...
            장갑은 피해자의 장갑일 가능성이 높습니다. 해당 검은 장갑은
            사진에서도 확인할 수 있듯이 피해자의 장갑이 맞습니다.
            <br />
            ...
            손수건을 이용할 수 있었고 강컨서는 평소에 장갑을 쓰고 있었습니다.
            <br />
